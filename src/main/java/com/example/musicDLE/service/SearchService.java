...
public class SearchService {
    ...
    public SearchDto<ArtistDto> searchArtistByName(String name){
        try{
    ...
    public ArtistDto searchArtistById(int id){
        try{
    ...
    public SearchDto<AlbumDto> searchAlbumByName(String name){
        try{
